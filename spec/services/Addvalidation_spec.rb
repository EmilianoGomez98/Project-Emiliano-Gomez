describe Addvalidation do
  ...
  context "Not successful validation" do
     ...
     context "key already exists and isn't expired, deploy error: 'NOT_STORED'" do
       it "key already exists " do
         Memdata.create_memdata("addv","0","1","1","a")
         statusCode = add_valid?("addv","3","0","1","val")
